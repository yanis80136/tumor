...
st.markdown(
    ...
    <h3 style='text-align: center;'>
        Author : <strong><em>Ferkioui Yanis</em></strong> 
...
st.markdown(
    """
    <h3 style='text-align: center;'>
        Supervisor : <strong><em>Muammar Sadrawi</em></strong> 
        <span style='font-size: 12px; color: gray;'>(Researcher in the Department of Bioinformatics I3L Jakarta | Indonesia)</span>
    </h3>
    """,
    unsafe_allow_html=True
)
    ...
    try:
        if source_image is None :
            ...
            if st.sidebar.button("Detect Tumor"):
                ...
                status_placeholder.info("⏳ Running detection...")
